...
class Project(BaseModel):
    ...
    owner_user_id associates the project with a specific user account in
    multi-tenant environments. Defaults to None for backward compatibility
    with legacy unassigned projects.
    """

    project_id: str = Field(default_factory=lambda: str(uuid.uuid4()))
    owner_user_id: Optional[str] = Field(default=None, description="ID of the user who owns this project")
