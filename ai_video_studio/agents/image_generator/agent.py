...
class ImageGenerationAgent:
    """
    Sixth node in the pipeline: (Scene + representative image_prompt) -> Image
    Generation -> ImageAsset. Runs once per scene (5 calls for a 5-scene story),
    not once per shot - that batching decision was made deliberately to keep
    cost and generation time down.
    """
